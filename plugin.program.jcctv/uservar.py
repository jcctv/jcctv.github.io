...
ADDONTITLE     = 'JCCTV Wizard'
BUILDERNAME    = 'JCC'
EXCLUDES       = [ADDON_ID, 'repository.jcctv', 'plugin.program.jcctv']
# Enable/Disable the text file caching with 'Yes' or 'No' and age being how often it rechecks in minutes
CACHETEXT      = 'Yes'
CACHEAGE       = 30
# Text File with build info in it.
BUILDFILE      = 'https://raw.githubusercontent.com/jcctv/jcctv.github.io/master/plugin.program.jcctv/resources/text/builds.txt'
...
HIDECONTACT    = 'Yes'
# You can add \n to do line breaks
CONTACT        = 'Thank you for choosing JCCTV Wizard.'
...
REPOID         = 'repository.jctv'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML   = 'https://raw.githubusercontent.com/jcctv/jcctv.github.io/master/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL     = 'https://raw.githubusercontent.com/jcctv/jctv.github.io/master/zips/'
#########################################################
